...
size_t idx_helper(const std::vector<T>& elements, const C& val, int l, int r)
{
  int middlle = (l+r)/2;
  size_t middle = size_t(middlle);
  size_t left = size_t(l);
  size_t right = size_t(r);
  //std::cout<<"where the fuck am I segaulting?!?!?!?!";
  ...
  {
		return idx_helper(elements, val, left, middle);
    //std::cout<<"where the fuck am I segaulting?!?!?!?!";
  }
	else
  {
		return idx_helper(elements, val, middle+1, right);
    //std::cout<<"where the fuck am I segaulting?!?!?!?!";
  }
}
...
size_t insertion_idx(const std::vector<T>& elements, const C& val)
{
    ...
    else
    {
      ...
      {
        //std::cout<<"where the fuck am I segaulting?!?!?!?!";
        return elements.size();//go right;
      }
      else if(elements[elements.size()-1]==val)
      {
        //std::cout<<"where the fuck am I segaulting?!?!?!?!";
        return elements.size()-1; //in current end;
      }
      else
      {
        //search
        return idx_helper(elements,val,0,elements.size()-1);
      }
      //std::cout<<"where the fuck am I segaulting?!?!?!?!";
    }
    return 5;
